...
"config.emptyExtensions": "No installed extensions.",
  ...
  "ctx.switches.fileContent": "Files only",
  "ctx.switches.fileContentTooltip": "Only trim tool outputs related to reading/writing files",
  "ctx.switches.commandOutput": "Terminal only",
  "ctx.switches.commandOutputTooltip": "Only trim large outputs from terminal commands",
  "ctx.switches.webFileContent": "File trim",
  "ctx.switches.webCommandOutput": "Cmd trim",
  "ctx.switches.keepRecent": "Keep Recent Tool Results",
  "ctx.switches.keepRecentTooltip": "Keep the full output of the last N tool calls verbatim",
  "ctx.switches.keepRecentUnit": " verbatim",
