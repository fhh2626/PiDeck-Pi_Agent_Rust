...
export const enUS: Record<TranslationKey, string> = {
  ...
  "app.worktreeRemoveNotFound": "Git worktree not found. It may have been removed outside PiDeck-Q.",
  ...
  "ctx.switches.commandOutputTooltip": "Include non-read tool outputs in context (omits bash/grep/websearch results when off)",
  ...
  "git.gitNotInstalledDesc": "Source control management requires Git. Please install Git from https://git-scm.com and restart PiDeck-Q.",
  "browser.devicePC": "PC",
  ...
  "app.preloadMissing": "Desktop preload API is not available. Restart PiDeck-Q.",
  ...
  "app.windowControls": "PiDeck-Q window controls",
  ...
  "config.extensionUninstalledToast":
	...
	"config.extensionDisabledToast": "{name} disabled. Restart agents for it to take effect.",
	"config.extensionEnabledToast": "{name} enabled. Restart agents for it to take effect.",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "editors.hint": "Manage external editors shown in the project menu. PiDeck-Q detects them asynchronously on first launch, and paths can be edited manually.",
  ...
  "config.emptySkills": "No skills yet. Create a global skill first.",
	"config.extensionRestartHint": "Create or restart agents after enabling, disabling, or uninstalling extensions.",
  ...
  "config.recommendedPackagesHint": "These extensions are compatible with PiDeck-Q. Some CLI-specific features (e.g. TUI) may not apply in the desktop version.",
  ...
  "config.extRecommended.piDeckNulRedirectFix": "Built into PiDeck-Q: fixes leftover file issues when pi redirects to the NUL device on Windows.",
  ...
  "config.restoreBuiltinPrompts": "Restore defaults",
  "config.restoreBuiltinPromptsTitle": "Restore default templates",
  "config.restoreBuiltinPromptsBody": "Restore all default templates?",
  "config.promptRestoredToast": "Default templates restored",
  ...
  "config.im.guideMethodAStep3": "Fill in the credentials in PiDeck-Q and connect",
  ...
  "config.im.guideMethodBStep6": "Get App ID and App Secret from 'Credentials & Basic Info', fill in PiDeck-Q",
  ...
  "settings.vision.configFileDesc": "The extension and PiDeck-Q share this file: it also works when editing manually with pi outside PiDeck-Q.",
  ...
  "usageStats.notInstalled.backfill": "The plugin only records conversations after installation. To backfill historical usage, run /analytics import in a pi terminal or in an agent started by PiDeck-Q",
  ...
  "usageStats.empty.backfill": "To backfill historical sessions from before installation, run /analytics import in a pi terminal or in an agent started by PiDeck-Q",
  ...
  "settings.sectionChatTypographyDesc": "Affects the chat answer only; the composer and UI controls keep their own spacing.",
  "settings.chatBodyLineHeight": "Body Line Height",
  "settings.chatBodyLineHeightDesc": "Line height for wrapped lines, regular lines and single newlines.",
  "settings.chatBlockGap": "Block Spacing",
  "settings.chatBlockGapDesc": "Spacing between paragraphs, blank lines and adjacent content blocks.",
  "settings.chatListDensity": "List Density",
  "settings.chatListDensityDesc": "Density of the list container and of list items.",
  "settings.chatCodeDensity": "Code & Table Density",
  "settings.chatCodeDensityDesc": "Code line height and spacing around code blocks and tables.",
  ...
  "settings.piRpcOfflineDesc": "For the original TypeScript pi, skip model-catalog network refresh at startup; pi_agent_rust does not accept this flag and ignores the setting.",
  ...
  "settings.electronSandboxDesc": "Controls Electron renderer sandbox (unrelated to pi Agent). Off by default for Windows AV/GPU compatibility. Requires restarting PiDeck-Q. Turn it back off if the app fails to start.",
  ...
  "settings.disableUpdateCheckDesc": "When enabled, stops auto-checking updates for PiDeck-Q and Pi CLI. Update buttons in settings will also be disabled.",
  ...
  "settings.piRuntimePreference": "Pi runtime version",
  "settings.piRuntimePreferenceHint": "Choose the original TypeScript pi or pi_agent_rust. Auto keeps the detected system command. The choice applies to newly started Agents.",
  "settings.piRuntimePreferenceAuto": "Auto-detect",
  "settings.piRuntimePreferenceTypescript": "Original pi (TypeScript)",
  "settings.piRuntimePreferenceRust": "pi_agent_rust (Rust)",
  "settings.piTypescriptPath": "Original pi path",
  "settings.piTypescriptPathHint": "Enter the original pi.cmd/pi.exe or legacy-pi path; leave blank to search PATH.",
  "settings.piTypescriptPathPlaceholder": "e.g. C:\\Users\\me\\AppData\\Roaming\\npm\\legacy-pi.cmd",
  "settings.piRustPath": "pi_agent_rust path",
  "settings.piRustPathHint": "Enter the pi_agent_rust, pi-rust, or pi.exe path; leave blank to search PATH.",
  "settings.piRustPathPlaceholder": "e.g. C:\\tools\\pi-rust\\pi.exe",
  "settings.piRuntimeDetectedRust": "Detected: pi_agent_rust",
  "settings.piRuntimeDetectedTypescript": "Detected: original TypeScript pi",
  ...
  "settings.wsl.apiUnavailable": "The WSL API is not ready. Restart PiDeck-Q and try again.",
  ...
  "settings.restartApp": "Restart PiDeck-Q",
  ...
  "settings.restartNotice":
    "Title bar changes take effect after restarting PiDeck-Q.",
  ...
  "settings.webQrDesc": "Scan this code with your phone to open PiDeck-Q Web",
  ...
  "settings.webQrAlt": "PiDeck-Q Web service QR code",
