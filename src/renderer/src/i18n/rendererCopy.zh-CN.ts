...
export const zhCN = {
  ...
  "ctx.switches.keepRecent": "保留最近",
  "ctx.switches.keepRecentUnit": "条",
  "ctx.switches.keepRecentTooltip": "保留最近 N 条工具结果原文不裁剪（无论开关如何；早于此范围的调用按下方开关过滤，默认 10）",
  "ctx.switches.fileContent": "文件内容",
  "ctx.switches.fileContentTooltip": "上下文包括历史 read 读出的文件正文（关闭时省略正文，保留路径与行号）",
  "ctx.switches.commandOutput": "命令输出",
  "ctx.switches.commandOutputTooltip": "上下文包括历史非 read 工具的输出（关闭时省略 bash/grep/websearch 等执行结果）",
  ...
  "ctx.switches.webFileContent": "文件",
  "ctx.switches.webCommandOutput": "命令",
  "app.cycleModel": "切换模型",
  "app.compact": "压缩",
  ...
  "git.gitNotInstalledDesc": "源代码管理功能需要 Git。请前往 https://git-scm.com 安装 Git 后重启 PiDeck-Q。",
  "browser.devicePC": "PC",
  ...
  "app.preloadMissing": "桌面端预加载 API 未注入，请重新启动 PiDeck-Q。",
  ...
  "app.windowControls": "PiDeck-Q 窗口控制",
  ...
  "config.extensionUninstalledToast": "扩展已卸载，重启 agent 后生效",
	"config.extensionDisabledToast": "{name} 已禁用，重启 agent 后生效",
	"config.extensionEnabledToast": "{name} 已启用，重启 agent 后生效",
...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "config.emptySkills": "暂无 Skill，可先创建一个全局 Skill。",
	"config.extensionRestartHint": "启用、禁用或卸载后需要新建或重启 agent 才会生效",
  ...
  "config.recommendedPackagesHint": "以下扩展与 PiDeck-Q 兼容，可直接安装使用。部分 CLI 特有功能（如 TUI 界面）在桌面端可能不适用。",
  ...
  "config.extRecommended.piDeckContextController": "PiDeck-Q 内置：上下文控制器。/context-keep 保留最近 N 条工具结果原文；/context-files 控制更早的 read 正文；/context-commands 控制更早的非 read 输出。默认全部保留且保留最近 10 条。",
  ...
  "config.extRecommended.piDeckNulRedirectFix": "PiDeck-Q 内置：修复 Windows 下 pi 重定向到 NUL 设备时可能产生的残留文件问题。",
  ...
  "config.restoreBuiltinPrompts": "找回默认模板",
  "config.restoreBuiltinPromptsTitle": "找回默认模板",
  "config.restoreBuiltinPromptsBody": "是否恢复全部默认模板？",
  "config.promptRestoredToast": "默认模板已恢复",
  ...
  "config.im.guideMethodAStep3": "在 PiDeck-Q 填入配置，点击保存后连接",
  ...
  "config.im.guideMethodBStep6": "在「凭证与基础信息」中获取 App ID 和 App Secret，填入 PiDeck-Q",
  ...
  "settings.vision.configFileDesc": "扩展与 PiDeck-Q 共享这份文件：脱离 PiDeck-Q 单独使用 pi 时也可手动编辑生效。",
  ...
  "usageStats.notInstalled.backfill": "插件只记录安装之后的对话。如需补上历史用量，可执行 /analytics import 回填，在 pi 终端或 PiDeck-Q 启动的 Agent 中均可",
  ...
  "usageStats.empty.backfill": "若安装前已有历史会话，可执行 /analytics import 回填，在 pi 终端或 PiDeck-Q 启动的 Agent 中均可",
  ...
  "settings.sectionChatTypographyDesc": "只影响会话正文，不影响输入框和界面控件。",
  "settings.chatBodyLineHeight": "正文行距",
  "settings.chatBodyLineHeightDesc": "控制自动换行、普通行和单个回车的行高。",
  "settings.chatBlockGap": "内容块间距",
  "settings.chatBlockGapDesc": "控制段落、空行和相邻内容块之间的距离。",
  "settings.chatListDensity": "列表密度",
  "settings.chatListDensityDesc": "控制列表整体和列表项之间的疏密。",
  "settings.chatCodeDensity": "代码与表格密度",
  "settings.chatCodeDensityDesc": "控制代码行高，以及代码块、表格与周围内容的距离。",
  "settings.typographyCompact": "紧凑",
  "settings.typographyDefault": "标准",
  "settings.typographyRelaxed": "宽松",
  "settings.typographyLoose": "很宽松",
  ...
  "settings.piRpcOfflineDesc": "原版 TypeScript pi 启动时跳过模型目录网络刷新；pi_agent_rust 不接受此参数，会自动忽略该开关。",
  ...
  "settings.electronSandboxDesc": "控制 Electron 渲染进程沙箱（与 pi Agent 无关）。默认关闭以兼容 Windows 安全软件/旧 GPU 驱动；开启后需重启 PiDeck-Q。若启动异常请改回关闭。",
  ...
  "settings.disableUpdateCheckDesc": "开启后不再自动检测 PiDeck-Q 和 Pi CLI 的版本更新，设置页中检测按钮也将禁用。",
  ...
  "settings.piRuntimePreference": "Pi 运行时版本",
  "settings.piRuntimePreferenceHint": "选择 PiDeck-Q 启动原版 TypeScript pi 或 pi_agent_rust；自动模式沿用系统检测结果。切换后新启动的 Agent 生效。",
  "settings.piRuntimePreferenceAuto": "自动检测",
  "settings.piRuntimePreferenceTypescript": "原版 pi（TypeScript）",
  "settings.piRuntimePreferenceRust": "pi_agent_rust（Rust）",
  "settings.piTypescriptPath": "原版 pi 路径",
  "settings.piTypescriptPathHint": "可填写原版 pi.cmd/pi.exe 或 legacy-pi 路径；留空时按 PATH 自动查找。",
  "settings.piTypescriptPathPlaceholder": "例如 C:\\Users\\me\\AppData\\Roaming\\npm\\legacy-pi.cmd",
  "settings.piRustPath": "pi_agent_rust 路径",
  "settings.piRustPathHint": "可填写 pi_agent_rust、pi-rust 或 pi.exe 路径；留空时按 PATH 自动查找。",
  "settings.piRustPathPlaceholder": "例如 C:\\tools\\pi-rust\\pi.exe",
  "settings.piRuntimeDetectedRust": "当前检测：pi_agent_rust",
  "settings.piRuntimeDetectedTypescript": "当前检测：原版 TypeScript pi",
  "settings.debug": "调试",
  ...
  "settings.webQrDesc": "用手机扫描二维码，直接打开 PiDeck-Q Web 服务",
  ...
  "settings.webQrAlt": "PiDeck-Q Web 服务二维码",
