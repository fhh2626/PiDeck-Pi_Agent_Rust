...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "ctx.switches.fileContent": "只截断文件内容",
  "ctx.switches.fileContentTooltip": "仅对读写文件类工具输出进行智能截断，保留其他命令输出",
  "ctx.switches.commandOutput": "只截断终端输出",
  "ctx.switches.commandOutputTooltip": "仅对 bash/terminal 工具的长输出进行智能截断",
  "ctx.switches.webFileContent": "文件截断",
  "ctx.switches.webCommandOutput": "命令截断",
  "ctx.switches.keepRecent": "保留最近工具结果",
  "ctx.switches.keepRecentTooltip": "保留最近 N 次工具调用的完整输出，更早的工具结果将被截断或替换为智能桩",
  "ctx.switches.keepRecentUnit": "条完整",
